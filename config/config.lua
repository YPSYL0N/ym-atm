...
-- 3D TEXT
Config.Text = '~b~[~y~E~b~]~s~ ATM' -- What should the 3D Text say
Config.DrawDistance = 2.0

-- Minigame
Config.Levels = 1 -- How many levels will there be
Config.Attempts = 6 -- How much attempts will there be (If you fail 1 attempt minus)
Config.Time = 3 -- How much time do you have (in minutes)
